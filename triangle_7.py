...
class Triangle(Scene):
    def construct(self):
        ...
        triangle_text_sur_1 = SurroundingRectangle(
            triangle_text_3, color='#ff00ff')
        triangle_text_3_gr = VGroup(triangle_text_3, triangle_text_sur_1)

        triangle_text_4 = self.texts(MathTex, r"S_{t}=31.937\approx 32 sq.units",
                                     None, triangle_text_2, None, None, DOWN, False, 0.5)
        triangle_text_4[0][0:2].set_color(YELLOW)
        triangle_text_4[0][3:5].set_color(BLUE)
        triangle_text_4[0][6:9].set_color(BLUE)
        triangle_text_4[0][10:12].set_color(BLUE)
        triangle_text_4.move_to(UP)

        triangle_text_sur_2 = SurroundingRectangle(
            triangle_text_4, color='#ff00ff')
        triangle_text_4_gr = VGroup(triangle_text_4, triangle_text_sur_2)
        triangle_text_4_gr.scale(2)
        # part 1
        ...
        self.add(rect_area_gr_1)
        self.add(triangle_text)
        self.add(triangle_text_1)
        self.add(triangle_text_2)
        self.add(triangle_text_3_gr)
        self.wait(2)
        self.play(FadeOut(rect_area_gr_1, triangle_text,
                  triangle_text_1, triangle_text_2), run_time=3)
        self.wait(2)
        self.play(FadeOut(task_text_1, img, line_dot, verts, auxiliary_dots,
                  dashed_line_d_p, dashed_line_c_f, x_text, y_text), run_time=3)
        self.wait(2)
        self.play(Transform(triangle_text_3_gr,
                  triangle_text_4_gr), run_time=3)
        self.wait(2)
